    ...
    <>
      <div className="flex flex-col-reverse md:flex-row-reverse shadow-md  justify-between w-full py-8">
        <div className="w-full md:w-1/2 lg:w-1/2 relative">
          ...
          <div className="p-3 md:pl-12 text-center md:mt-8 md:text-left font-sans font-light text-medium text-gray-800 md:text-lg">
            If you have questions or need assistance, please do not hesitate and
            contact us by email at{" "}
            <span className="text-gray-800">support@notics.com</span> or via{" "}
            <span className="text-gray-800">Twitter</span>
          </div>

          <div className="p-3 md:pl-12 text-center mx-auto md:mt-0 md:text-left font-sans font-light text-medium text-gray-800 ">
        ...
        <div className="w-full md:w-1/2 lg:w-1/2  ">
          <div>
            <h2 className="p-3 md:pl-12 text-center md:text-left font-serif font-bold text-xl md:text-xl text-black">
              Schedule a meeting
            </h2>
            <div className="px-3 md:pl-12 text-center md:text-left font-sans font-light text-gray-800 text-medium ">
            ...
            <form className="p-3 md:pl-12">
              ...
              <div className="  text-sm md:text-medium text-center  text-gray-800">
