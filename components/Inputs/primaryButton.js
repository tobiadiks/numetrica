...
export default function PrimaryButton(props) {
  return (
    ...
    :
      <button onClick={props.onClick} className="w-full  py-3 my-3 px-4  font-semibold  focus:outline-none focus:shadow-md hover:shadow-lg rounded-sm text-white  bg-main-brand1  shadow-main-brand1 text-center"><span><FontAwesomeIcon icon={props.icon}/>&nbsp;</span>{props.title}</button>
    }
    </div>
  );
}
