  ...
  return (
    <div className="min-h-screen flex flex-col relative md:flex-row md:transform translate-y-1 md:-translate-y-2">
      <div className="w-full md:w-1/2 flex  align-middle flex-col bg-green-500">
        <div className="w-24 h-24 backdrop-filter rounded-lg backdrop-brightness-110 md:mt-6 mt-20 mx-auto flex">
        ...
        <div className="px-4 py-4 bg-white m-12 rounded-lg">
          ...
          <div className="p-4 m-8 bg-green-50 rounded-lg ">
            <Image
              layout="responsive"
              alt="B"
              src={"/chat.svg"}
      ...
      <div className="w-full md:w-1/2 flex  align-middle flex-col bg-blue-500">
        ...
        <div className="px-4 py-4 bg-white m-12 rounded-lg">
          ...
          <div className="p-4 m-8 bg-blue-50 rounded-lg ">
            <Image
              layout="responsive"
              alt="B"
              src={"/critter.svg"}
