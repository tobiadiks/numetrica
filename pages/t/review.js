    ...
    <div className="flex flex-col md:flex-row lg:flex-row justify-start space-y-0 ">
          ...
          <div className="h-screen overflow-y-scroll">
            ...
            <div className="mt-8">
              ...
              <div className="md:w-11/12 lg:w-11/12 w-full py-1 my-1 px-4 flex justify-between align-middle">
                <div>
                  <input type="checkbox" />{" "}
                  <span className="text-led-text ml-3">5 Star</span>
                </div>{" "}
                <div>
                  <span className="text-led-text">73</span>
                </div>
              </div>
              ...
              <div className="md:w-11/12 lg:w-11/12 w-full py-1 my-1 px-4 flex justify-between align-middle">
                <div>
                  <input type="checkbox" />{" "}
                  <span className="text-led-text ml-3">4 Star</span>
                </div>{" "}
                <div>
              ...
              <div className="md:w-11/12 lg:w-11/12 w-full py-1 my-1 px-4 flex justify-between align-middle">
                <div>
                  <input type="checkbox" />{" "}
                  <span className="text-led-text ml-3">3 Star</span>
                </div>{" "}
                <div>
                  <span className="text-led-text">22</span>
                </div>
              </div>
              ...
              <div className="md:w-11/12 lg:w-11/12 w-full py-1 my-1 px-4 flex justify-between align-middle">
                <div>
                  <input type="checkbox" />{" "}
                  <span className="text-led-text ml-3">2 Star</span>
                </div>{" "}
                <div>
                  <span className="text-led-text">5</span>
                </div>
              </div>
              ...
              <div className="md:w-11/12 lg:w-11/12 w-full py-1 my-1 px-4 flex justify-between align-middle">
                <div>
                  <input type="checkbox" />{" "}
                  <span className="text-led-text ml-3">1 Star</span>
                </div>{" "}
                <div>
                  <span className="text-led-text">3</span>
                </div>
              </div>
            </div>
      ...
      <div className="w-full  md:w-1/4 lg:w-1/4 flex flex-col justify-start align-middle bg-deep-blue">
        <div className="">
          ...
          <div className="md:full lg:w-full w-full flex flex-col justify-center align-middle text-led-text py-5 px-3">
            <div className="flex justify-between  mt-2">
